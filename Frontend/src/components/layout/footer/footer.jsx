...
const Footer = () => {
  ...
  <div className="row px-xl-5 pt-5">
    <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5 ">
      <h5 className="text-secondary text-uppercase mb-4 text-white">Get In Touch</h5>
      <p className="mb-4">
    ...
    <div className="col-lg-8 col-md-12">
      <div className="row">
        <div className="col-md-4 mb-5">
          <h5 className="text-secondary text-uppercase mb-4 text-white">Quick Shop</h5>
          <div className="d-flex flex-column justify-content-start">
            <a className="text-secondary mb-2" href="/">
              <i className="fa fa-angle-right mr-2" />
              Home
            </a>
            <a className="text-secondary mb-2" href="/products">
              <i className="fa fa-angle-right mr-2" />
              Our Shop
            </a>
            <a className="text-secondary mb-2" href="#">
        ...
        <div className="col-md-4 mb-5">
          <h5 className="text-secondary text-uppercase mb-4 text-white">My Account</h5>
          <div className="d-flex flex-column justify-content-start">
            <a className="text-secondary mb-2" href="/">
              <i className="fa fa-angle-right mr-2" />
              Home
        ...
        <div className="col-md-4 mb-5">
          <h5 className="text-secondary text-uppercase mb-4 text-white">Newsletter</h5>
