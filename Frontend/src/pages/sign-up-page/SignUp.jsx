                        ...
                        <div className="col-12 col-md-6">
                            ...
                            <form className="row g-3 needs-validation" novalidate>
                                ...
                                <div className="row">
                                    <div className="form-floating mb-3 col-6">
                                        ...
                                        <label className="mx-1" htmlFor="floatingInput">First Name*</label>
                                    </div>
                                    <div className="form-floating mb-3 col-6">
                                        <input minLength="4" type="text" className="form-control"
                                               id="floatingInput" placeholder="name@example.com"
                                               onChange={e => this.setState({lastName: e.target.value})}/>
                                        <label className="mx-1" htmlFor="floatingInput">Last Name</label>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="form-floating mb-3 col-6">
                                        ...
                                        <label className="mx-1"  htmlFor="floatingInput">Address Line 1*</label>
                                    </div>
                                    <div className="form-floating mb-3 col-6">
                                        <input minLength="4" type="text" className="form-control"
                                               id="floatingInput" placeholder="name@example.com"
                                               onChange={e => this.setState({addL2: e.target.value})}/>
                                        <label className="mx-1" htmlFor="floatingInput">Address Line 2</label>
                                    </div>
                                    <div className="form-floating mb-3 col-6">
                                        <input minLength="4" type="text" className="form-control"
                                               id="floatingInput" placeholder="name@example.com"
                                               onChange={e => this.setState({addL3: e.target.value})}/>
                                        <label className="mx-1" htmlFor="floatingInput">Address Line 3</label>
                                    </div>
                                    <div className="form-floating mb-3 col-6">
                                        <input required minLength="4" type="text" className="form-control"
                                               id="floatingInput" placeholder="name@example.com"
                                               onChange={e => this.setState({phoneNumber: e.target.value})}/>
                                        <label className="mx-1" htmlFor="floatingInput">Phone Number*</label>
                                    </div>
                            ...
                            <p style={{textAlign: "right",margin:'2px'}}>
                                {this.state.loading ? (
                                    ...
                                    <button className="btn btn-primary reg-but" type="submit" onClick={this.handleSubmit}>Register</button>
                                }
